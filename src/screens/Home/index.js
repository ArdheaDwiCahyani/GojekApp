...
import {SearchNormal, Money, ArrowUp, Repeat, More, User, Car, Cake} from 'iconsax-react-native';
  ...
  return (
    ...
    <View style={styles.container1}>
      ...
      <View style={{ flexDirection: 'column', alignItems: 'center' }}>
            ...
            <Text style={{ color: 'black', marginLeft: 10, fontSize:14 }}>Segernya Sama,</Text>
            <Text style={{ color: 'black', marginLeft: 10, fontSize:14 }}>Bebas Gula</Text>
            <Text style={{ color: 'black', marginLeft: 10, fontSize:10, fontStyle:"italic" }}></Text>
      </View>
    ...
    <View style={styles.card}>
        ...
        <Money style={{ justifyContent: 'center', alignSelf: 'center'}} size={25} variant="Linear" color='#246ef0'/>
          <View style={{ flexDirection: 'column', marginRight:15 }}>  
            <Text style={{marginRight:15, color:'#246ef0'}}>RP150.000</Text>
            <Text style={{marginRight:15, color:'#246ef0'}}>20 coins</Text>
          </View>
          <View style={{ flexDirection: 'column', alignItems:'center', }}>  
    ...
    <View style={styles.card2}>
        ...
        <User style={{ justifyContent: 'center', alignSelf: 'center'}} size={25} variant="Linear" color='#040506'/>
            <Text style={{ color:'#0a0a0a'}}>Account</Text>
        </View>
        <View style={{ flexDirection: 'column', alignItems:'center', margin:10, }}>  
    ...
    <Image
      style={styles.image}
      source={{ uri: 'https://www.grab.com/id/wp-content/uploads/sites/9/2016/09/Visual-Web.jpg' }}/>
