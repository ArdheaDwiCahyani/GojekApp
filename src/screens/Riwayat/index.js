  ...
  return (
    <View style={home.container}>
      <ScrollView horizontal style={{ paddingHorizontal: 20 }} showsHorizontalScrollIndicator={false}>
        <View style={{ backgroundColor: '#F3F3F3', padding: 10, borderRadius: 25, marginHorizontal: 5 }}>
      ...
      <View style={{ paddingHorizontal: 20, marginTop: 20, }}>
        <Text style={{ color: 'black', fontSize: 14, }}>6 November, 2023</Text>
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          ...
          <View style={{ flexDirection: 'row', flex: 1, justifyContent: 'space-between', alignItems: 'center' }}>
            <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', paddingLeft: 10, }}>Kost Putri 44</Text>
            <Text style={{ color: 'black', fontSize: 14 }}>Rp10.000</Text>
          </View>
        </View>
      </View>
      <View style={{ paddingHorizontal: 20, marginTop: 20, }}>
        <Text style={{ color: 'black', fontSize: 14, }}>30 Oktober, 2023</Text>
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          <Image
            source={scooter}
            style={home.icon}
          />
          <View style={{ flexDirection: 'row', flex: 1, justifyContent: 'space-between', alignItems: 'center' }}>
            <Text style={{ color: 'black', fontSize: 16, fontWeight: 'bold', paddingLeft: 10, }}>Kampus ITN 1</Text>
