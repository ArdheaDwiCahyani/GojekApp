      ...
      <ScrollView>
        <View style={{ marginTop: 10 }}>
          <View style={{ ...styles.imageContainer, paddingHorizontal: 20, marginBottom: 20 }}>
            <Image
              source={{
                uri: 'https://img.freepik.com/free-vector/beautiful-young-woman-hand-drawn-cartoon-art-illustration_56104-1088.jpg?w=740&t=st=1699884220~exp=1699884820~hmac=7176d31aa1a056013749732e5c451143516c77bad07e5a4003c5cc852b849746',
              }}
              style={{ ...styles.profileImage }}
            />
            <View style={{ marginLeft: 10 }}>
              <Text style={styles.profileName}>Ardhea Dwi Cahyani</Text>
              <View style={{ alignItems: 'center', flexDirection: 'row', }}>
                <Star color={'rgb(255, 125, 0)'} variant="Linear" size={24} />
                <Text style={{ ...styles.profileInfo, color: 'rgb(255, 125, 0)', fontWeight: 'bold', paddingLeft: 5, }}>Owner</Text>
              </View>
            </View>
          </View>
